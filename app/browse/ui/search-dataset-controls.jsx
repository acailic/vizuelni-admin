...
export const SearchDatasetControls = ({ browseState: { inputRef, search, onSubmitSearch, includeDrafts, setIncludeDrafts, order = SearchCubeResultOrder.CreatedDesc, onSetOrder, }, cubes, }) => {
    ...
    return (<Flex sx={{ justifyContent: "space-between", alignItems: "center", mb: 2 }}>
      <SearchDatasetResultsCount cubes={cubes}/>
      <Flex sx={{ alignItems: "center", gap: 5 }}>
        <SearchDatasetDraftsControl checked={includeDrafts} onChange={onToggleIncludeDrafts}/>
        <Divider flexItem orientation="vertical"/>
        <SearchDatasetSortControl value={order} onChange={onSetOrder} disableScore={!isSearching}/>
      </Flex>
    </Flex>);
};
