...
describe("Color Utilities", () => {
    ...
    describe("getFittingColorInterpolator", () => {
        const mockGetColorInterpolator = vi.fn((paletteId) => (t) => `color-${paletteId}-${t}`);
        const sequentialPalette = {
            label: "Blues",
            value: "blues",
            interpolator: (t) => `blues-${t}`,
        };
        const divergingPalette = {
            label: "RdBu",
            value: "RdBu",
            interpolator: (t) => `rdbu-${t}`,
        };
        const customSequentialPalette = {
            type: "sequential",
            paletteId: "custom-sequential",
            name: "Custom Sequential",
            colors: ["#ff0000", "#0000ff"],
        };
        const customDivergingPalette = {
            type: "diverging",
            paletteId: "custom-diverging",
            name: "Custom Diverging",
            colors: ["#ff0000", "#0000ff", "#00ff00"],
        };
        const customCategoricalPalette = {
            type: "categorical",
        ...
        it("should handle sequential color config", () => {
            ...
            const interpolator = getFittingColorInterpolator(config, mockGetColorInterpolator);
