 ...
 */
export const buildCopyChartUrl = (configKey, locale) => {
 ...
 */
export const buildShareChartUrl = (configKey, locale) => {
 ...
 * // Returns: "https://example.com/en/v/chart-123"
 */
export const buildViewChartUrl = (configKey, locale) => {
 ...
 */
export const buildNewChartUrl = (locale) => {
 ...
 */
export const buildEditChartUrl = (configKey, locale) => {
 ...
 */
export const useChartUrls = (locale) => {
    return {
        /**
         * Get copy URL for a chart
         * @param configKey - The chart configuration key
         */
        getCopyUrl: (configKey) => buildCopyChartUrl(configKey, locale),
        /**
         * Get share URL for a chart
         * @param configKey - The chart configuration key
         */
        getShareUrl: (configKey) => buildShareChartUrl(configKey, locale),
        /**
         * Get view URL for a chart
         * @param configKey - The chart configuration key
         */
        getViewUrl: (configKey) => buildViewChartUrl(configKey, locale),
        /**
         ...
         * @param configKey - The chart configuration key
         */
        getEditUrl: (configKey) => buildEditChartUrl(configKey, locale),
    };
};
