...
<Intro
  title="Visualize Serbian Open Government Data 🇷🇸"
  teaser="Create and embed visualizations from any dataset provided by the Serbian Open Data Portal (data.gov.rs)."
...
<Actions
  contribute={{
    ...
    description:
      "Find out how you can integrate your data into the Serbian Open Data Portal.",
