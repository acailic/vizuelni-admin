...
export { Configurator, ConfiguratorStateProvider, useConfiguratorState, } from "../configurator";
export { defaultLocale, i18n, locales, parseLocaleString, } from "../locales/locales";
