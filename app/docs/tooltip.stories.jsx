...
const TooltipContent = ({ children }) => (<Box sx={{ fontSize: "0.875rem" }}>{children}</Box>);
const TooltipBoxStory = () => (<ReactSpecimen>
    <InteractiveFiltersChartProvider chartConfigKey="column-chart">
      <ColumnChart limits={{
        axisDimension: undefined,
        limitMeasure: undefined,
        limits: [],
    }} observations={observations} measures={measures} measuresById={keyBy(measures, (d) => d.id)} dimensions={dimensions} dimensionsById={keyBy(dimensions, (d) => d.id)} chartConfig={{
        key: "column-chart",
        ...
        <Flex>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "left", y: "top" }} margins={margins}>
              <TooltipContent>Left / Top </TooltipContent>
            </TooltipBox>
          </div>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "center", y: "top" }} margins={margins}>
              <TooltipContent>Center / Top </TooltipContent>
            </TooltipBox>
          </div>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "right", y: "top" }} margins={margins}>
        ...
        <Flex>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "left", y: "middle" }} margins={margins}>
              <TooltipContent>Left / Middle </TooltipContent>
            </TooltipBox>
          </div>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "center", y: "middle" }} margins={margins}>
              <TooltipContent>Center / Middle </TooltipContent>
            </TooltipBox>
          </div>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "right", y: "middle" }} margins={margins}>
        ...
        <Flex>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "left", y: "bottom" }} margins={margins}>
              <TooltipContent>Left / Bottom </TooltipContent>
            </TooltipBox>
          </div>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "center", y: "bottom" }} margins={margins}>
              <TooltipContent>Center / Bottom </TooltipContent>
            </TooltipBox>
          </div>
          <div style={{ width: 200, height: 150, position: "relative" }}>
            <Dot />
            <TooltipBox x={100} y={100} placement={{ x: "right", y: "bottom" }} margins={margins}>
...
export { RulerStory as Ruler, TooltipBoxStory as TooltipBox, TooltipContentStory2 as TooltipContent2, TooltipContentStory as TooltipContent, };
const TooltipContentStory = {
    render: () => (<InteractiveFiltersChartProvider chartConfigKey="column-chart">
      <ColumnChart limits={{
            axisDimension: undefined,
            limitMeasure: undefined,
            limits: [],
        ...
        <div style={{ width: 200, height: 150, position: "relative" }}>
          <Dot />
          <TooltipBox x={100} y={100} placement={{ x: "left", y: "top" }} margins={margins}>
            <TooltipSingle xValue="Jahr 2017" segment="10'987'372" yValue="Alpen"/>
          </TooltipBox>
        </div>
      </ColumnChart>
    </InteractiveFiltersChartProvider>),
    ...
    render: () => (<InteractiveFiltersChartProvider chartConfigKey="column-chart">
      <ColumnChart limits={{
        ...
        <div style={{ width: 200, height: 150, position: "relative" }}>
          <Dot />
          <TooltipBox x={100} y={100} placement={{ x: "right", y: "middle" }} margins={margins}>
            <TooltipMultiple xValue="Jahr 2014" segmentValues={[
...
const RulerStory = {
    render: () => {
        return (<div style={{ width: 200, height: 450, position: "relative" }}>
        <RulerContent rotate={false} xValue={"2014"} values={[
                {
                    label: "Zürich",
                    value: "450",
                    color: "Orchid",
            ...
            ]} chartHeight={450} margins={{ top: 10, right: 10, bottom: 10, left: 10 }} xAnchor={100} datum={{
                label: "Zürich",
                value: "450",
                color: "Orchid",
