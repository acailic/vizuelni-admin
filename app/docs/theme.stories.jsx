...
const StorybookBody = ({ children, ...props }) => (<Box {...props}>{children}</Box>);
const StorybookSection = ({ children, ...props }) => (<Box {...props}>{children}</Box>);
const StorybookSectionTitle = ({ children, ...props }) => (<Typography variant="h2" {...props}>
    {children}
  </Typography>);
...
const paletteKeyComparator = (a, b) => {
...
export const TypographyStory = () => (<StorybookSection>
    ...
    return (<StorybookSection>
      ...
      <Box sx={{
        ...
        {[0, 1, 2, 3, 4, 5, 6, 12].map((x) => {
            return (<Card key={x} elevation={x} sx={{ width: 100, height: 100, p: 2 }}>
...
export const Components = () => {
    ...
    return (<>
      <FormControlLabel label={"Inverted"} control={<Checkbox checked={inverted} onChange={(_ev, value) => setInverted(value)}/>}/>
      <Box>
        <StorybookSection>
        ...
        <StorybookSection>
          ...
          {["error", "success", "info", "warning"].map((color) => (<Alert key={color} color={color} sx={{ mb: 1 }}>
        ...
        <StorybookSection>
          ...
          <div>
            ...
            <FormControlLabel label={"Checkbox"} control={<Checkbox defaultChecked={false}/>}/>
            <FormControlLabel label={"Checkbox"} control={<Checkbox indeterminate/>}/>
          </div>
          <FormControl>
          ...
          <Autocomplete multiple value={["Vanilla"]} renderInput={(params) => <TextField {...params}/>} options={["Chocolate", "Vanilla", "Strawberry"]}/>
          <FormControlLabel label="Switch" control={<Switch sx={{ ml: 2, mr: 1 }}/>}/>
        </StorybookSection>
        <StorybookSection>
          <StorybookSectionTitle>Tooltips</StorybookSectionTitle>
          <Tooltip open placement="right" title={<Typography>Tooltip</Typography>}>
        ...
        <StorybookSection>
          ...
          <Menu open={!!menuAnchorEl} anchorEl={menuAnchorEl} onClose={() => setMenuAnchorEl(undefined)}>
...
const SnackbarExample = () => {
    ...
    const renderButton = (variant) => {
        const formatted = `${variant[0].toUpperCase()}${variant === null || variant === void 0 ? void 0 : variant.substring(1)}`;
        return (<Button onClick={() => enqueueSnackbar({
                variant: variant,
    ...
    return (<Stack gap="1rem" direction="row">
      {renderButton("error")}
