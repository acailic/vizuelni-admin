...
export default meta;
const LineChartStory = () => (<ConfiguratorStateProvider chartId="published" initialState={{
    ...
    <InteractiveFiltersProvider chartConfigs={[chartConfig]}>
      <InteractiveFiltersChartProvider chartConfigKey={chartConfig.key}>
        ...
        limits: [],
    }} observations={observations} dimensions={dimensions} dimensionsById={keyBy(dimensions, (d) => d.id)} measures={measures} measuresById={keyBy(measures, (d) => d.id)} chartConfig={chartConfig}>
            <ChartContainer>
              <ChartSvg>
                <BrushTime />
            ...
            {fields.segment && (<LegendColor chartConfig={chartConfig} symbol="line" interactive showTitle/>)}
          </LineChart>
        </Observer>
