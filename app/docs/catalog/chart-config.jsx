...
${(<ImageSpecimen plain={true} span={4} src="./static/docs/design/chart-config/flow-general.png"/>)}
...
${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.1.1_l_configuration_bar-chart.png" description="[Default Bar-Chart](./static/docs/design/chart-config/2.1.1_l_configuration_bar-chart.png)"/>)}

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.1.2_l_configuration_bar-chart_stacked.png" description="[Stacked Bar-Chart](./static/docs/design/chart-config/2.1.2_l_configuration_bar-chart_stacked.png)"/>)}
...
${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.2.1_l_configuration_column-chart.png" description="[Default Column-Chart](./static/docs/design/chart-config/2.2.1_l_configuration_column-chart.png)"/>)}

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.2.2_l_configuration_column-chart_stacked.png" description="[Stacked Column-Chart](./static/docs/design/chart-config/2.2.2_l_configuration_column-chart_stacked.png)"/>)}

${(<ImageSpecimen plain={true} src="./static/docs/design/chart-config/2.2.3_l_configuration_column-chart_stacked.png" span={3} description="[Normalized (Percentage) Column-Chart](./static/docs/design/chart-config/2.2.3_l_configuration_column-chart_stacked.png)"/>)}

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.2.4_l_configuration_column-chart_grouped.png" description="[Grouped Column-Chart](./static/docs/design/chart-config/2.2.4_l_configuration_column-chart_grouped.png)"/>)}

## 2.3 Line-Chart

A line chart is a type of chart which displays information as a series of data points (e.g. time) connected by a line.

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.3.1_l_configuration_line-chart.png" description="[Default Line-Chart](./static/docs/design/chart-config/2.3.1_l_configuration_line-chart.png)"/>)}

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.3.2_l_configuration_line-chart_multi-line.png" description="[Multi-Line Chart](./static/docs/design/chart-config/2.3.2_l_configuration_line-chart_multi-line.png)"/>)}
...
${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.4.1_l_configuration_area.png" description="[Default Area-Chart](./static/docs/design/chart-config/2.4.1_l_configuration_area.png)"/>)}

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.4.2_l_configuration_area-chart_stacked.png" description="[Stacked Area-Chart](./static/docs/design/chart-config/2.4.2_l_configuration_area-chart_stacked.png)"/>)}
...
${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.5.1_l_configuration_scatterplot.png" description="[Default Scatterplot](./static/docs/design/chart-config/2.5.1_l_configuration_scatterplot.png)"/>)}

${(<ImageSpecimen plain={true} span={3} src="./static/docs/design/chart-config/2.5.2_l_configuration_scatterplot_grouped.png" description="[Grouped Scatterplot](./static/docs/design/chart-config/2.5.2_l_configuration_scatterplot_grouped.png)"/>)}
`;
export default Doc;
