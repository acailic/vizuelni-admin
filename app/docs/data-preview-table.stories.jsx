...
export default meta;
const PreviewTableStory = () => (<Paper>
    <DataTablePreview linkToMetadataPanel={false} title="My dataset preview" dimensions={dimensions} measures={measures} observations={observations["data"].slice(0, 10)}/>
  </Paper>);
