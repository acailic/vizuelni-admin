...
Examples of how the feature would be beneficial and an estimate of the potential impact.
Please describe...
...
export const featureRequestTemplates = {
  "sr-Latn": featureRequestSrLatn,
  "sr-Cyrl": featureRequestSrLatn,
  en: featureRequestEn,
};
