...
function SvgIcWarningCircle(props) {
    return (<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M7.685 5.397A8.292 8.292 0 0112.292 4a8.301 8.301 0 018.291 8.292A8.291 8.291 0 117.685 5.397zm.417 13.165a7.542 7.542 0 004.19 1.271 7.55 7.55 0 007.541-7.541 7.542 7.542 0 10-11.731 6.27z" fill="currentColor"/>
    </svg>);
}
