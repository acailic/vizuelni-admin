...
export default function DemographicsDemo() {
    ...
    const percentageChange = ((populationChange2024to2050 / population2024.total) *
        100).toFixed(1);
    const title = i18n._(t({
    ...
    return (<DemoLayout title={title} description={description} datasetInfo={{
      ...
      <Box>
        <Alert severity="warning" sx={{ mb: 4, fontSize: "1.1rem", fontWeight: 500 }}>
          <Trans id="demos.demographics.alert.detail" values={{
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} md={6} lg={3}>
            ...
            male: (((totalMale * 1000) / totalPopulation) *
                100).toFixed(1),
            female: (((totalFemale * 1000) / totalPopulation) *
                100).toFixed(1),
        }))}
                </Typography>
              </CardContent>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Grid container spacing={2}>
            {regionalPopulation.map((region) => (<Grid item xs={12} sm={6} md={3} key={region.region}>
                ...
                share: ((region.population / (totalPopulation / 1000)) *
                    100).toFixed(1),
            }))}
                    </Typography>
                  </CardContent>
