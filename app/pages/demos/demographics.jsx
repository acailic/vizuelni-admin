        ...
        <Paper elevation={2} sx={{ p: 3 }}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <Box sx={{ mb: 2 }}>
                <Chip label={locale === 'sr' ? 'Negativna stopa rasta' : 'Negative growth rate'} color="error" sx={{ mr: 1, mb: 1 }}/>
            ...
            : `Growth rate: ${demographicStats.populationGrowthRate}% annually`}
              ...
              <Box sx={{ mb: 2 }}>
                <Chip label={locale === 'sr' ? 'Niska stopa nataliteta' : 'Low birth rate'} color="error" sx={{ mr: 1, mb: 1 }}/>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  {locale === 'sr'
            ...
            : `Birth rate: ${demographicStats.birthRate} per 1,000 population`}
              ...
              <Box sx={{ mb: 2 }}>
                <Chip label={locale === 'sr' ? 'Visoka stopa mortaliteta' : 'High death rate'} color="warning" sx={{ mr: 1, mb: 1 }}/>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  {locale === 'sr'
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ mb: 2 }}>
                <Chip label={locale === 'sr' ? 'Starenje stanovništva' : 'Aging population'} color="warning" sx={{ mr: 1, mb: 1 }}/>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  {locale === 'sr'
            ...
            : `High elderly ratio: ${dependencyRatios.elderly} (65+ per 100 working-age)`}
              ...
              <Box sx={{ mb: 2 }}>
                <Chip label={locale === 'sr' ? 'Očekivani životni vek' : 'Life expectancy'} color="info" sx={{ mr: 1, mb: 1 }}/>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  {locale === 'sr'
            ...
            : `Males: ${demographicStats.lifeExpectancyMale} yrs • Females: ${demographicStats.lifeExpectancyFemale} yrs`}
              ...
              <Box sx={{ mb: 2 }}>
                <Chip label={locale === 'sr' ? 'Urbanizacija' : 'Urbanization'} color="default" sx={{ mr: 1, mb: 1 }}/>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  {locale === 'sr'
