...
export default function DigitalDemo() {
    ...
    return (<DemoLayout title={title} description={description} datasetInfo={{
      ...
      <Box>
        ...
        <Alert severity="success" sx={{ mb: 4, fontSize: '1.1rem', fontWeight: 500 }}>
          {locale === 'sr' ? (<>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ height: 500 }}>
            <LineChart data={digitalSkillsTrends.map(d => ({
            year: d.year.toString(),
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ height: 450 }}>
            <LineChart data={eCommerceTrends.map(d => ({
            year: d.year.toString(),
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ height: 450 }}>
            <LineChart data={eGovernmentTrends.map(d => ({
            year: d.year.toString(),
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ height: 450 }}>
            <ColumnChart data={techIndustryGrowth.map(d => ({
            year: d.year.toString(),
            'Exports (€M)': d.exports,
        }))} xKey="year" yKey="Exports (€M)" width={950} height={450}/>
          </Box>
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} md={6}>
            ...
            : 'Social Media - Penetration (2023)'}
              ...
              <BarChart data={socialMediaUsage.map(s => ({
            platform: s.platform,
            penetration: s.penetration
        }))} xKey="platform" yKey="penetration" width={450} height={400}/>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            : 'Annual User Growth by Platform'}
              ...
              <ColumnChart data={socialMediaUsage.map(s => ({
            platform: s.platform,
            growth: s.growthRate
        }))} xKey="platform" yKey="growth" width={450} height={400}/>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ height: 450 }}>
            <BarChart data={digitalDivide.map(d => ({
            demographic: d.demographic,
            access: d.access
        }))} xKey="demographic" yKey="access" width={950} height={450}/>
          </Box>
        </Paper>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ height: 450 }}>
            <LineChart data={freelancersTrends.map(d => ({
            year: d.year.toString(),
