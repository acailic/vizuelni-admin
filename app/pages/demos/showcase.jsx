...
export default function DemoShowcasePage() {
    ...
    const text = {
        ...
        economyDesc: i18n._(t({ id: 'demos.showcase.economy.description', message: 'Year-over-year GDP growth by region.' })),
        transportTitle: i18n._(t({ id: 'demos.showcase.transport.title', message: 'Public Transport Momentum' })),
        transportDesc: i18n._(t({
        ...
        energyDesc: i18n._(t({ id: 'demos.showcase.energy.description', message: 'Share of electricity generation by source.' })),
        digitalTitle: i18n._(t({ id: 'demos.showcase.digital.title', message: 'Digital Skills Gap' })),
        digitalDesc: i18n._(t({
      ...
      <Card sx={{
        ...
        <Grid container spacing={3} alignItems="center">
          <Grid item xs={12} md={7}>
            ...
            message: 'A visually coherent set of charts spotlighting momentum, drops, source mix, and the skills gap.'
        }))}
            </Typography>
          </Grid>
          ...
          <Card sx={{ height: '100%', borderRadius: 3, boxShadow: '0 14px 40px rgba(0,0,0,0.08)' }}>
            <CardContent>
              ...
              <Box sx={{ overflowX: 'auto', pb: 1 }}>
                <ColumnChart data={showcaseRegionalGrowth} xKey="region" yKey="growth" width={760} height={360} xLabel={i18n._(t({ id: 'demos.showcase.economy.xlabel', message: 'Region' }))} yLabel={i18n._(t({ id: 'demos.showcase.economy.ylabel', message: 'Growth (%)' }))}/>
              </Box>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ height: '100%', borderRadius: 3, boxShadow: '0 14px 40px rgba(0,0,0,0.08)' }}>
            <CardContent>
              ...
              <Box sx={{ overflowX: 'auto', pb: 1 }}>
                <LineChart data={showcaseRidershipTrend} xKey="year" yKey="trips" width={760} height={360} xLabel={i18n._(t({ id: 'demos.showcase.transport.xlabel', message: 'Year' }))} yLabel={i18n._(t({ id: 'demos.showcase.transport.ylabel', message: 'Million trips' }))} color="#0ea5e9"/>
              </Box>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ height: '100%', borderRadius: 3, boxShadow: '0 14px 40px rgba(0,0,0,0.08)' }}>
            <CardContent>
              ...
              <Box sx={{ overflowX: 'auto', pb: 1 }}>
                <ColumnChart data={showcaseDigitalSkills} xKey="segment" yKey="share" width={760} height={360} xLabel={i18n._(t({ id: 'demos.showcase.digital.xlabel', message: 'Segment' }))} yLabel={i18n._(t({ id: 'demos.showcase.digital.ylabel', message: 'Share (%)' }))} colors={["#22c55e"]}/>
              </Box>
            </CardContent>
          </Card>
        </Grid>
