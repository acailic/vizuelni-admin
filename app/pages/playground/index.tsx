    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Alert severity="info" sx={{ mb: 4 }}>
        {locale === "sr" ? (
          ...
          <>
            <strong>How to use:</strong> Customize the chart using the controls
            on the right. Changes are applied instantly. Use the share panel to
            get a link or embed code.
          </>
        )}
      </Alert>
