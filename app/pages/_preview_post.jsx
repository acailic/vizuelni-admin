...
const Page = () => {
    return (<Box sx={{ display: "flex", gap: 2, p: 6 }}>
      <form method="post" action="preview_post" target="_blank">
        <input type="hidden" name="chartState" value={JSON.stringify(photovoltaikanlagenState)}/>
        <input type="submit" value="☀️ Preview a Photovoltaikanlagen chart"/>
      </form>
      <form method="post" action="preview_post" target="_blank">
        <input type="hidden" name="chartState" value={JSON.stringify(nfiState)}/>
    ...
    chartConfig: {
        ...
        filters: {
            ...
            "https://environment.ld.admin.ch/foen/nfi/classificationUnit": {
                type: "single",
                value: "https://environment.ld.admin.ch/foen/nfi/ClassificationUnit/1266/1",
            },
        },
        interactiveFiltersConfig: {
            legend: {
            ...
            timeRange: {
                active: false,
                componentIri: "https://environment.ld.admin.ch/foen/nfi/classificationUnit",
                presets: {
                    type: "range",
                    from: "",
                    to: "",
