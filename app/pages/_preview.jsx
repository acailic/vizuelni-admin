...
const loadIframe = (id, config) => {
    const iframe = document.getElementById(id);
    const handleMessage = (e) => {
        var _a, _b;
        if (((_a = e.data) === null || _a === void 0 ? void 0 : _a.type) === "ready" && e.source === iframe.contentWindow) {
            (_b = iframe.contentWindow) === null || _b === void 0 ? void 0 : _b.postMessage(config, "*");
...
const Page = () => {
    ...
    return (<Box sx={{
      ...
      <iframe id="chart-column" src={`/${locale}/preview${objectToHashString(CONFIGURATOR_STATE_COLUMN)}`}/>
...
const CONFIGURATOR_STATE_COLUMN = {
    ...
    dataSet: "https://energy.ld.admin.ch/sfoe/bfe_ogd84_einmalverguetung_fuer_photovoltaikanlagen/2",
    dataSource: {
        type: "sparql",
