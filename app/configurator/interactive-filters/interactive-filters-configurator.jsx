...
export const InteractiveFiltersConfigurator = ({ state, }) => {
    ...
    if (data === null || data === void 0 ? void 0 : data.dataCubesComponents) {
        ...
        const animationComponent = allComponents.find((d) => d.id === getFieldComponentId(fields, "animation"));
        const canFilterAnimation = isAnimationInConfig(chartConfig);
        if (!canFilterAnimation) {
            return null;
        }
        return (<ControlSection role="tablist" aria-labelledby="controls-interactive-filters" collapse defaultExpanded={false}>
        ...
        <ControlSectionContent gap="none" px="none">
          ...
          <ControlTabField chartConfig={chartConfig} fieldComponents={animationComponent ? [animationComponent] : []} value="animation" labelId={null} {...(_a = ANIMATION_FIELD_SPEC.getDisabledState) === null || _a === void 0 ? void 0 : _a.call(ANIMATION_FIELD_SPEC, chartConfig, dimensions, [])}/>
