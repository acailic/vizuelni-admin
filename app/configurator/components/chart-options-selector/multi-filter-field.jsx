...
export const MultiFilterField = ({ chartConfig, component, encoding, field, dimensions, measures, }) => {
    ...
    return encoding.filters && component ? (<ControlSection data-testid="chart-edition-multi-filters" collapse>
      ...
      <ControlSectionContent component="fieldset" gap="none">
        ...
        {(isTemporalDimension(component) ||
            ...
            field !== "segment" ? (<TimeFilter dimension={component} disableInteractiveFilters={encoding.disableInteractiveFilters}/>) : (component &&
            !isMeasure(component) && (<DimensionValuesMultiFilter dimension={component} field={field} colorComponent={colorComponent}/>))}
