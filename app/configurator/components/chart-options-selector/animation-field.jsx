      ...
      <ControlSectionContent component="fieldset" gap="none" sx={{ mt: 2 }}>
        ...
        {field.showPlayButton && (<>
            <Box mt={4}>
              ...
              <RadioGroup>
                {[10, 30, 60].map((d) => (<ChartOptionRadioField key={d} label={`${d}s`} field="animation" path="duration" value={d}/>))}
              </RadioGroup>
            </Box>
            <Box mt={4}>
              <Flex alignItems="center" sx={{ gap: 1, mb: 1 }}>
                ...
                message: "Use the Stepped type to make the animation jump between data points at fixed intervals. This mode is useful when you want to animate data using a time dimension with a non-uniform distribution of dates.",
            })}>
                  <Typography sx={{ color: "primary.main", lineHeight: "0 !important" }}>
              ...
              <RadioGroup>
                ...
                message: "Continuous",
            })} field="animation" path="type" value="continuous"/>
                <ChartOptionRadioField label={t({
                id: "controls.section.animation.type.stepped",
                message: "Stepped",
            })} field="animation" path="type" value="stepped"/>
              </RadioGroup>
            </Box>
            ...
            })} field="animation" path="dynamicScales"/>
              <Tooltip arrow title={t({
                id: "controls.section.animation.dynamic-scaling.explanation",
                message: "Enable dynamic scaling to adjust the chart's scale based on the data range, ensuring optimal visualization.",
            })}>
                <Typography sx={{ color: "primary.main", lineHeight: "0 !important" }}>
                  <SvgIcInfoCircle width={16} height={16}/>
                </Typography>
