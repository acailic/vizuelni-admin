...
export const parseDate = (dateStr) => {
  ...
  return (_e =
    (_d =
      (_c =
        (_b =
          (_a = timeUnitToParser.Second(dateStr)) !== null && _a !== void 0
            ? _a
            : timeUnitToParser.Minute(dateStr)) !== null && _b !== void 0
          ? _b
          : timeUnitToParser.Day(dateStr)) !== null && _c !== void 0
        ? _c
        : timeUnitToParser.Month(dateStr)) !== null && _d !== void 0
      ? _d
      : timeUnitToParser.Year(dateStr)) !== null && _e !== void 0
    ? _e
...
const getErrorMeasure = ({ dimensions, measures, type }, valueIri) => {
  return [...dimensions, ...measures].find((m) => {
    var _a;
    return (_a = m.related) === null || _a === void 0
      ? void 0
      : _a.some((r) => r.type === type && r.id === valueIri);
  });
};
export const useErrorMeasure = (
  componentId,
  { dimensions, measures, type }
) => {
  return useMemo(() => {
...
export const mapValueIrisToColor = ({
  ...
  const paletteValues =
    (customPalette === null || customPalette === void 0
      ? void 0
      : customPalette.colors) || getPalette({ paletteId });
  const colors = dimensionValues.map(
    (d, i) =>
      (paletteId === "dimension" && d.color) ||
      (oldColorMapping === null || oldColorMapping === void 0
        ? void 0
...
export const getComponentLabel = (component, { cubeIri } = {}) => {
  ...
  if (isJoinByComponent(component)) {
    ...
    return (_a = component.originalIds[0].label) !== null && _a !== void 0
      ? _a
      : "NO LABEL";
  }
...
export const getComponentDescription = (dim, cubeIri) => {
  ...
  if (isJoinByComponent(dim)) {
    ...
    return (_a = dim.originalIds[0].description) !== null && _a !== void 0
      ? _a
      : "";
  } else {
