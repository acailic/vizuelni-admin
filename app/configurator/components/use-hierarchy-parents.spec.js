...
describe("grouping hierarchy by parents", () => {
    it("should work", () => {
        ...
        const iri = "https://ld.admin.ch/cube/dimension/aussenhandel_warenkoerbe/1_listZT";
        const ztGroups = groups.filter(([parents]) => parents.length > 0 && parents[parents.length - 1].value === iri);
