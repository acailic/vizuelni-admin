...
export const LayoutBlocksSelector = () => {
    ...
    return activeBlock ? (<div key={activeBlock.key} role="tabpanel" id={`control-panel-block-${activeBlock.key}`} aria-labelledby={`tab-block-${activeBlock.key}`} tabIndex={-1}>
      <ControlSection hideTopBorder>
        ...
        <ControlSectionContent>
          {orderedLocales.map((locale) => (<TextBlockInputField key={locale} locale={locale}/>))}
