...
describe("TimeInput", () => {
    ...
    const setup = ({ isOptional, id }) => {
        let currentValue = "";
        const root = render(<TimeInput id={id} label={id} value={currentValue} timeFormat="%Y-%m-%d" formatLocale={getD3TimeFormatLocale("en")} isOptional={isOptional} onChange={(e) => (currentValue = e.currentTarget.value)}/>);
