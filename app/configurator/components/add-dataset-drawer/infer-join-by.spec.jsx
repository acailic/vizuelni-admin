...
const selectedSearchDimensions = [
    {
        type: "temporal",
...
const cubeElectricityPriceCanton = {
    ...
    dimensions: [
        {
            id: stringifyComponentId({
                unversionedCubeIri: "https://energy.ld.admin.ch/elcom/electricityprice-canton",
                unversionedComponentIri: "https://energy.ld.admin.ch/elcom/electricityprice/dimension/period",
            }),
            label: "Period",
        ...
        },
        {
            id: stringifyComponentId({
                unversionedCubeIri: "https://energy.ld.admin.ch/elcom/electricityprice-canton",
                unversionedComponentIri: "https://energy.ld.admin.ch/elcom/electricityprice/dimension/canton",
            }),
            label: "Canton",
            timeUnit: "",
            termsets: [
...
describe("find dimension for option", () => {
    it("should find dimension for temporal option", () => {
        const result = findDimensionForOption(selectedSearchDimensions[0], cubeElectricityPriceCanton.dimensions);
...
describe("inferJoinBy", () => {
    it("should infer join-by dimensions correctly", () => {
        const result = inferJoinBy(selectedSearchDimensions, cubeElectricityPriceCanton);
        expect(result).toMatchInlineSnapshot(`
{
    ...
    it("shoud infer infer join-by dimensions correctly 2", () => {
        const options = {
            options: [
                {
                    type: "temporal",
                    id: "https://energy.ld.admin.ch/sfoe/bfe_ogd84_einmalverguetung_fuer_photovoltaikanlagen(VISUALIZE.ADMIN_COMPONENT_ID_SEPARATOR)https://energy.ld.admin.ch/sfoe/bfe_ogd84_einmalverguetung_fuer_photovoltaikanlagen/Jahr",
                    originalIds: [
                        {
                            cubeIri: "https://energy.ld.admin.ch/sfoe/bfe_ogd84_einmalverguetung_fuer_photovoltaikanlagen/10",
                ...
                {
                    type: "shared",
                    id: "https://energy.ld.admin.ch/sfoe/bfe_ogd84_einmalverguetung_fuer_photovoltaikanlagen(VISUALIZE.ADMIN_COMPONENT_ID_SEPARATOR)https://energy.ld.admin.ch/sfoe/bfe_ogd84_einmalverguetung_fuer_photovoltaikanlagen/Kanton",
                    label: "Kanton",
                    termsets: [
                        {
                            iri: "https://ld.admin.ch/dimension/canton",
