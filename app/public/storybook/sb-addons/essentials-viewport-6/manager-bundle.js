try {
  (() => {
    ...
    var ye = (e, t, a) => (
      ...
      Se(
        t || !e || !e.__esModule
          ? $(a, "default", { value: e, enumerable: !0 })
          : a,
        e
      )
    );
    ...
    var le = be((ce, X) => {
      ...
      w();
      (function (e) {
        if (typeof ce == "object" && typeof X < "u") X.exports = e();
        ...
        return (function s(c, b, p) {
          ...
          for (var i = typeof k == "function" && k, h = 0; h < p.length; h++)
            o(p[h]);
          return o;
        })(
          {
        ...
        return l.createElement(
          ...
          l.createElement(
            ...
            l.createElement(
              ...
              t !== P
                ? l.createElement(ke, null, t.name, " ", c ? "(L)" : "(P)")
                : null
            )
          ),
          l.createElement(Y, {
