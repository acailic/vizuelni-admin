try {
  (() => {
    ...
    var Q = se((J, Y) => {
      ...
      f();
      (function (e) {
        if (typeof J == "object" && typeof Y < "u") Y.exports = e();
        ...
        return (function r(i, d, l) {
          ...
          for (var n = typeof A == "function" && A, u = 0; u < l.length; u++)
            t(l[u]);
          return t;
        })(
          {
                ...
                i.exports = function (a) {
                  ...
                  return function (S) {
                    var m = function () {
                      ...
                      for (E = 0; E < v; E++) {
                        if (
                          ((w[E] = { cacheItem: b, arg: arguments[E] }),
                          b.has(arguments[E]))
                        ) {
                          b = b.get(arguments[E]);
                          continue;
