...
const getCubeDimensionMock = (iri, order) => {
    return {
        path: {
            value: iri,
        },
...
describe("PossibleFilters", () => {
    const runTest = async (cubeIri, filters, dimensionsMetadata, expectedQuery) => {
    ...
    it("should generate a correct SPARQL query without ordering", async () => await runTest("cube", {
        "dim1/2": {
            type: "single",
            value: "val1",
        },
...
ORDER BY DESC(?d1)
LIMIT 1`));
    it("should generate a correct SPARQL query with ordering", async () => await runTest("cube", {
        "dim1/2": {
            type: "single",
            value: "val1",
        },
...
LIMIT 1`);
    ...
    it("should generate a correct SPARQL query based on real cube", async () => await runTest(mockChartConfig.data.dataSet, mockChartConfig.data.chartConfig.filters, 
