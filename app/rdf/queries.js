...
const getDimensionUnits = (d) => {
  ...
  const t =
    (_a = d.out(ns.qudt.unit).term) !== null && _a !== void 0
      ? _a
      : d.out(ns.qudt.hasUnit).term;
  return t ? [t] : [];
};
  ...
  try {
    const dimensions = cube.dimensions
      ...
      .filter((d) => {
        ...
        if (componentIris) {
          const iri =
            (_a = d.path) === null || _a === void 0 ? void 0 : _a.value;
          return (
...
export const createCubeDimensionValuesLoader =
  (sparqlClient, cache, filters) => async (resolvedDimensions) => {
...
const getMinMaxDimensionValues = async (
  ...
  if (
    ...
    const min =
      (_a = parseObservationValue({ value: minInclusive })) !== null &&
      _a !== void 0
        ? _a
        : 0;
    const max =
      (_b = parseObservationValue({ value: maxInclusive })) !== null &&
      _b !== void 0
        ? _b
        : 0;
    return [
  ...
  while (
    ...
    !((_c = listItemPointer.out(ns.rdf.rest).term) === null || _c === void 0
      ? void 0
      : _c.equals(ns.rdf.nil))
  ) {
...
const getRegularDimensionsValues = async (
  ...
  const cubeIri =
    (_a = cube.term) === null || _a === void 0 ? void 0 : _a.value;
...
const isObservationDimension = (dim) => {
  ...
  return !!(
    ...
    ![ns.rdf.type.value, ns.cube.observedBy.value].includes(
      (_a = dim.path.value) !== null && _a !== void 0 ? _a : ""
    )
  );
};
export const dimensionIsVersioned = (dimension) => {
  var _a;
  return !!((_a = dimension.out(ns.schema.version)) === null || _a === void 0
    ? void 0
    : _a.value);
};
export const getCubeObservations = async ({
  ...
  const unversionedCubeIri =
    (_b = await queryCubeUnversionedIri(sparqlClient, cubeIri)) !== null &&
    _b !== void 0
      ? _b
      : cubeIri;
  ...
  const resolvedDimensions = allResolvedDimensions.filter((d) => {
    if (componentIris) {
      return (
        ...
        d.data.related.find((r) =>
          componentIris === null || componentIris === void 0
            ? void 0
  ...
  return (d) => {
    ...
    for (const [iri, valueSet] of sets.entries()) {
      ...
      const valueToCheck = isVersioned
        ? (_b =
            (_a = d[unversionedDimensionIri(iri)]) === null || _a === void 0
              ? void 0
              : _a.value) !== null && _b !== void 0
          ? _b
          : (_c = d[iri]) === null || _c === void 0
            ? void 0
            : _c.value
        : (_d = d[iri]) === null || _d === void 0
          ? void 0
          : _d.value;
...
const buildFilters = async ({
  ...
  return await Promise.all(
    Object.entries(filters).flatMap(async ([filterComponentId, filter]) => {
      var _a, _b, _c;
      const iri =
        (_a = parseComponentId(filterComponentId).unversionedComponentIri) !==
          null && _a !== void 0
          ? _a
          : filterComponentId;
      const cubeDimension = cube.dimensions.find((d) => {
        var _a;
        return (
          ((_a = d.path) === null || _a === void 0 ? void 0 : _a.value) === iri
        );
      });
      if (!cubeDimension) {
      ...
      switch (filter.type) {
        case "single": {
          if (isMostRecentValue(filter.value)) {
            const maxValue = await loadMaxDimensionValue(
              (_b = cube.term) === null || _b === void 0 ? void 0 : _b.value,
              {
                dimensionIri: resolvedDimension.data.iri,
                cubeDimensions: cube.dimensions,
                sparqlClient,
        ...
        case "range": {
          ...
          const maxValue = isMostRecentValue(filter.to)
            ? await loadMaxDimensionValue(
                (_c = cube.term) === null || _c === void 0 ? void 0 : _c.value,
                {
                  dimensionIri: resolvedDimension.data.iri,
                  cubeDimensions: cube.dimensions,
                  sparqlClient,
...
async function fetchViewObservations({
  ...
  if (!preview && limit !== undefined) {
    ...
    observationsView.ptr.addOut(ns.cubeView.projection, (projection) =>
...
function parseObservation(cubeDimensions, raw) {
  return (obs) => {
    ...
    for (const d of cubeDimensions) {
      const label =
        (_a = obs[labelDimensionIri(d.data.iri)]) === null || _a === void 0
          ? void 0
          : _a.value;
      const termType =
        (_b = obs[d.data.iri]) === null || _b === void 0 ? void 0 : _b.termType;
      const isVersioned = dimensionIsVersioned(d.dimension);
      const value =
        termType === "Literal" &&
        ns.cube.Undefined.equals(
          (_c = obs[d.data.iri]) === null || _c === void 0
            ? void 0
            : _c.datatype
        )
          ? null
      ...
      const finalValue =
        (_g =
          unversionedValue !== null && unversionedValue !== void 0
            ? unversionedValue
            : (_f = obs[d.data.iri]) === null || _f === void 0
              ? void 0
        ...
        : (_j =
              (_h =
                label !== null && label !== void 0
                  ? label
                  : unversionedValue) !== null && _h !== void 0
                ? _h
