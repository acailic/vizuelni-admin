...
SELECT ?${DIMENSION_IRI} ?${VERSION} ?${NODE_KIND} WHERE {
  ...
  return results.map((result) => {
    ...
    return {
      ...
      isLiteral:
        ((_a = result[NODE_KIND]) === null || _a === void 0
          ? void 0
          : _a.value) === ns.sh.Literal.value,
    };
  });
};
      ...
      const isVersioned =
        (_a =
          metadata === null || metadata === void 0
            ? void 0
            : metadata.isVersioned) !== null && _a !== void 0
          ? _a
          : false;
      const isLiteral =
        (_b =
          metadata === null || metadata === void 0
            ? void 0
            : metadata.isLiteral) !== null && _b !== void 0
          ? _b
          : false;
      return {
        i,
...
const parsePossibleFilters = (
  observation,
  { unversionedCubeIri, queryFilters }
) => {
