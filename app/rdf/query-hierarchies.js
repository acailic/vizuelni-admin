...
const getName = (pointer, language) => {
  var _a, _b;
  const name =
    (_a = pointer.out(ns.schema.name, { language })) === null || _a === void 0
      ? void 0
      : _a.value;
  if (name) {
    return name;
  }
  return (_b = pointer.out(ns.schema.name)) === null || _b === void 0
    ? void 0
    : _b.value;
};
const toTree = (results, dimensionId, locale, hasValue) => {
  ...
  const serializeNode = (node, depth) => {
    ...
    const identifier = parseTerm(
      (_a = node.resource.out(ns.schema.identifier)) === null || _a === void 0
        ? void 0
        : _a.term
    );
    ...
    const res = name
      ? {
          label: name || "-",
          alternateName:
            (_b = node.resource.out(ns.schema.alternateName).term) === null ||
            _b === void 0
              ? void 0
              : _b.value,
          value,
          ...
          position:
            (_c = parseTerm(node.resource.out(ns.schema.position).term)) !==
              null && _c !== void 0
              ? _c
              : 0,
          identifier,
