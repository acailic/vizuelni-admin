...
export const unemploymentTrends = [
...
export const employmentStats = {
    ...
    youthUnemploymentVsEU: 24.8 - 14.8,
    ...
    averageWageDifferenceWithEU: Math.round(wageComparison.reduce((sum, sector) => sum + Math.abs(sector.difference), 0) / wageComparison.length),
