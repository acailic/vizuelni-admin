...
export interface TrafficFatalitiesData {
  year: number;
  totalFatalities: number;
  fatalitiesPer100kPopulation: number;
  seriousInjuries: number;
  totalAccidents: number;
  pedestrianFatalities: number;
  motorcyclistFatalities: number;
  youngDriverFatalities: number; // 18-24 years
}

export interface AccidentCauses {
  cause: string;
  causeEn: string;
  percentage: number;
  fatalities: number;
...
export interface RoadInfrastructure {
  ...
  totalRoadsKm: number;
  highwaysKm: number;
  roadQualityGoodPercentage: number;
  roadQualityPoorPercentage: number;
  safetyBarriersKm: number;
  lightedRoadsPercentage: number;
}

export interface ComparativeData {
  country: string;
  fatalitiesPer100k: number;
  year: number;
}

// Traffic fatalities trends - ALARMING
export const trafficFatalities: TrafficFatalitiesData[] = [
  {
    year: 2015,
    totalFatalities: 607,
...
export const accidentCauses: AccidentCauses[] = [
  {
...
export const roadInfrastructure: RoadInfrastructure[] = [
  {
    year: 2015,
    totalRoadsKm: 45622,
    highwaysKm: 823,
...
export const comparativeData: ComparativeData[] = [
...
export const trafficStats = {
  ...
  comparisonWithEUAvg: 7.1 - 4.2, // Serbia vs EU average
  ...
  fatalityIncreaseSince2020: trafficFatalities[trafficFatalities.length - 1].totalFatalities -
                              trafficFatalities[5].totalFatalities, // 2020 is at index 5
