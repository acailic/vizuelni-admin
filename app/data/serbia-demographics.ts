 ...
 */
export const agePopulationData: AgeGroup[] = [
 ...
 */
export const populationTrends: PopulationYear[] = [
...
export const demographicStats = {
  totalPopulation: 6640000, // Current estimate
  maleProportion: 0.487,
  femaleProportion: 0.513,
  medianAge: 43.4,
  birthRate: 8.9, // per 1,000 population
  deathRate: 16.8, // per 1,000 population
  lifeExpectancyMale: 73.5,
  lifeExpectancyFemale: 78.7,
  populationGrowthRate: -0.6, // percent per year
...
export const dependencyRatios = {
  youth: 24.5, // Population aged 0-14 per 100 population aged 15-64
  elderly: 32.8, // Population aged 65+ per 100 population aged 15-64
