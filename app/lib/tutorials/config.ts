...
export interface TutorialStep {
  ...
  type: 'instruction' | 'code' | 'demo' | 'exercise' | 'quiz';
  content: {
    sr: string;
    en: string;
  };
...
export interface TutorialConfig {
  ...
  category: 'getting-started' | 'creating-charts' | 'embedding' | 'api-usage' | 'advanced';
 ...
 */
export function getTutorialConfig(id: string): TutorialConfig | null {
 ...
 */
export function getTutorialsByCategory(category: string): TutorialConfig[] {
 ...
 */
export function getTutorialTitle(id: string, locale: 'sr' | 'en' = 'sr'): string {
 ...
 */
export function getTutorialDescription(id: string, locale: 'sr' | 'en' = 'sr'): string {
  const config = getTutorialConfig(id);
