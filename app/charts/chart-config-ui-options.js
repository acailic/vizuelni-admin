...
const onColorComponentIdChange = (
  id,
  ...
  if (component) {
    ...
    if (
      ...
      const paletteId = getDefaultCategoricalPaletteId(
        component,
        colorPalette === null || colorPalette === void 0
          ? void 0
...
export const ANIMATION_FIELD_SPEC = {
  ...
  getDisabledState: (chartConfig, components) => {
    ...
    const fieldComponentsMap = Object.fromEntries(
      Object.entries(fieldHasComponentId(chartConfig))
    ...
    if (
      ...
      ((_b =
        (_a = chartConfig.fields.segment) === null || _a === void 0
          ? void 0
          : _a.sorting) === null || _b === void 0
        ? void 0
        : _b.sortingType) === "byTotalSize"
    ) {
      return {
        disabled: true,
        warnMessage: t({
  ...
  const segments = Array.from(
    new Set(
      data.map((d) => {
        var _a;
        return getSegment(
          (_a = fields.segment) === null || _a === void 0
            ? void 0
            : _a.componentId
        )(d);
      })
...
export const defaultSegmentOnChange = (
  id,
          ...
          adjustScaleDomain: {
            getDefaultDomain: ({ chartConfig, observations }) => {
              ...
              const getY = (o) => {
                var _a, _b;
                const y =
                  (_a = o[chartConfig.fields.y.componentId]) !== null &&
                  _a !== void 0
                    ? _a
                    : null;
                return (_b = parseOptionalNumericVariable(y)) !== null &&
                  _b !== void 0
                  ? _b
                  : 0;
              };
          ...
          adjustScaleDomain: {
            getDefaultDomain: ({ chartConfig, observations }) => {
              ...
              const getX = (o) => {
                var _a, _b;
                const x =
                  (_a = o[chartConfig.fields.x.componentId]) !== null &&
                  _a !== void 0
                    ? _a
                    : null;
                return (_b = parseOptionalNumericVariable(x)) !== null &&
                  _b !== void 0
                  ? _b
                  : 0;
              };
            ...
            onChange: (ids, options) => {
              ...
              const newColorMapping = Object.fromEntries(
                ids.map((id, i) => {
                  ...
                  return [
                    id,
                    (_a = color.colorMapping[i]) !== null && _a !== void 0
                      ? _a
                      : palette[i],
                  ];
                })
