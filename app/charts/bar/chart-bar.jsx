...
const ChartBars = memo((props) => {
    ...
    return (<>
      {((_a = fields.segment) === null || _a === void 0 ? void 0 : _a.componentId) && fields.segment.type === "stacked" ? (<StackedBarsChart {...props}>
          <ChartContainer>
            <ChartSvg>
              <AxisWidthLinear />
        ...
        </StackedBarsChart>) : ((_b = fields.segment) === null || _b === void 0 ? void 0 : _b.componentId) && fields.segment.type === "grouped" ? (<GroupedBarChart {...props}>
          <ChartContainer>
            <ChartSvg>
              <AxisWidthLinear />
              <AxisHideYOverflowRect />
        ...
        </GroupedBarChart>) : (<BarChart {...props} limits={limits}>
          <ChartContainer>
            <ChartSvg>
              <AxisWidthLinear />
              <AxisHideYOverflowRect />
