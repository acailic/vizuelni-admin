...
export const useBarValueLabelsData = () => {
    const { bounds: { width, height }, showValues, renderEveryNthValue, chartData, getRenderingKey, xScale, getX, yScale, getY, valueLabelFormatter, getValueOffset, } = useChartState();
