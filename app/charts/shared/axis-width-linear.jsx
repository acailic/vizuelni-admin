...
export const AxisWidthLinear = () => {
    ...
    const { xScale, bounds, xAxisLabel, xMeasure, chartType, bottomAxisLabelSize, } = useChartState();
    const { chartWidth, chartHeight, margins } = bounds;
    const { labelColor, labelFontSize, axisLabelFontSize, gridColor, fontFamily, } = useChartTheme();
