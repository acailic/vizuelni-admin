...
export const AxisTime = () => {
    ...
    const { xScale, yScale, bounds, xDimension, xAxisLabel, bottomAxisLabelSize, } = useChartState();
    const { chartHeight, chartWidth, margins } = bounds;
    const { labelColor, gridColor, domainColor, labelFontSize, fontFamily, axisLabelFontSize, } = useChartTheme();
    ...
    return (<>
      <foreignObject x={margins.left + chartWidth / 2 - bottomAxisLabelSize.width / 2} y={margins.top + chartHeight + xAxisTitleOffset} width={chartWidth} height={bottomAxisLabelSize.height} style={{ display: "flex" }}>
