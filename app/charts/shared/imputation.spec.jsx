...
describe("imputation", () => {
    ...
    const expectedLinearlyInterpolatedValue = previousValue +
    ...
    it("should return linearly interpolated value", () => {
        ...
        expect(Math.round(interpolatedValue * 1e5) / 1e5).toEqual(Math.round(expectedLinearlyInterpolatedValue * 1e5) / 1e5);
    });
    it("should impute linearly interpolated value and leave present values intact", () => {
        ...
        expect(Math.round(dataToImpute[1].value * 1e5) / 1e5).toEqual(Math.round(expectedLinearlyInterpolatedValue * 1e5) / 1e5);
