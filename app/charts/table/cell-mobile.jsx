...
export const DDContent = ({ cell, columnMeta, }) => {
    ...
    const { columnComponentType, textColor, textStyle, barShowBackground, barColorBackground, barColorNegative, barColorPositive, } = columnMeta;
    switch (columnMeta.type) {
        ...
        case "category": {
            ...
            return (<LinkedCellWrapper cell={cell} columnMeta={columnMeta} links={links}>
