...
export const useColumnValueLabelsData = () => {
    const { bounds: { width, height }, showValues, getValueOffset, renderEveryNthValue, chartData, getRenderingKey, xScale, getX, yScale, getY, valueLabelFormatter, } = useChartState();
