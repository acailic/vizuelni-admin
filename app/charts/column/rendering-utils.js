          ...
          .call((g) =>
            g
                ...
                maybeTransition(g, {
                  ...
                  s: (g) =>
                    g.attr("y", (d) => {
                      ...
                      return (
                        d.y +
                        ((_a = d.valueLabelOffset) !== null && _a !== void 0
                          ? _a
                          : 0)
                      );
                    }),
              ...
              .style("color", function (d) {
                var _a;
                return (_a = d.valueLabelColor) !== null && _a !== void 0
                  ? _a
                  : select(this).style("color");
              })
              .text((d) => {
                var _a;
                return (_a = d.valueLabel) !== null && _a !== void 0 ? _a : "";
              })
          ),
      (update) => {
            ...
            g
              ...
              .call((g) =>
                g
                  ...
                  .text((d) => {
                    var _a;
                    return (_a = d.valueLabel) !== null && _a !== void 0
                      ? _a
                      : "";
                  })
              ),
 ...
 */
export function shouldShowRoundedCorners(theme, explicitOverride) {
 ...
 */
export function calculateBarRadius(theme, barHeight) {
  const baseRadius =
