...
export const useMapStateVariables = (chartProps) => {
  ...
  const areaLayerDimension = dimensions.find(
    (d) =>
      d.id ===
      (areaLayer === null || areaLayer === void 0
        ? void 0
  ...
  const symbolLayerDimension = dimensions.find(
    (d) =>
      d.id ===
      (symbolLayer === null || symbolLayer === void 0
        ? void 0
...
export const useMapStateData = (
  ...
  const areaLayer = useMemo(() => {
    const id =
      areaLayerDimension === null || areaLayerDimension === void 0
        ? void 0
        : areaLayerDimension.id;
    if (!(id && shapes)) {
      return;
    }
  ...
  const symbolLayer = useMemo(() => {
    if (isGeoCoordinatesDimension(symbolLayerDimension) && coordinates) {
      ...
      data.chartData.forEach((d) => {
        ...
        const coords =
          (_a = coordsByLabel[value]) !== null && _a !== void 0
            ? _a
            : coordsByLabel[label];
        if (coords) {
