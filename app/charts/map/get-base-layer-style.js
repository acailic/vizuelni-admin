...
const greyStyle = replaceStyleTokens(greyStyleBase, tokens);
const emptyStyle = {
    version: 8,
    name: "Empty",
    metadata: {
...
const getBaseLayerStyle = ({ locale, showLabels, }) => {
    ...
    return greyStyleTextAdjusted;
};
export const useMapStyle = ({ locale, showBaseLayer, showLabels, }) => {
    const style = useMemo(() => {
        if (showBaseLayer) {
