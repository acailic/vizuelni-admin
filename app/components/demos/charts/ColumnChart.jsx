...
export const ColumnChart = ({ data, xKey, yKey, width = 800, height = 400, margin = { top: 20, right: 30, bottom: 60, left: 80 }, colors = ['#ff9800', '#ff5722', '#f44336', '#e91e63', '#9c27b0', '#673ab7'], xLabel = '', yLabel = '', multiSeries = false, stacked = false, showZeroLine = false }) => {
    ...
    useEffect(() => {
        ...
        if (stacked && isMultiSeries) {
            ...
            maxY = max(data.map(d => seriesKeys.reduce((sum, key) => sum + (Number(d[key]) || 0), 0))) || 0;
        }
        else {
