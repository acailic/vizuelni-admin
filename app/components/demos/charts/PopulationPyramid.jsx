...
export const PopulationPyramid = memo(({ data, width = 800, height = 600, margin = { top: 40, right: 60, bottom: 60, left: 60 }, maleColor = "#2196f3", femaleColor = "#f50057", title = "Population Pyramid", }) => {
