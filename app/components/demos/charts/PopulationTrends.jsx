...
export const PopulationTrends = ({ data, width = 900, height = 500, margin = { top: 50, right: 80, bottom: 70, left: 80 }, historicalColor = '#2196f3', projectionColor = '#ff9800', title = 'Population Trends' }) => {
