...
export const PopulationPyramid = memo(
  ({
    data,
    width = 800,
    height = 600,
      ...
      g.selectAll(".male-bar")
        ...
        .on("mouseover", function (_event, d) {
          ...
          const tooltip = g
            ...
            .attr(
              "transform",
              `translate(${innerWidth / 2 - 10}, ${(yScale(d.ageRange) || 0) + yScale.bandwidth() / 2})`
            );
      ...
      g.selectAll(".female-bar")
        ...
        .on("mouseover", function (_event, d) {
          ...
          const tooltip = g
            ...
            .attr(
              "transform",
              `translate(${innerWidth / 2 + (innerWidth / 2 - xScale(0)) + 10}, ${(yScale(d.ageRange) || 0) + yScale.bandwidth() / 2})`
            );
