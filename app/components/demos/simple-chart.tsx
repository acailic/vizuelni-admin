...
const translations = {
  noData: {
    sr: "Nema podataka za prikaz",
    en: "No data to display",
  },
  noKeys: {
    sr: "Nije moguće detektovati kolone",
    en: "Unable to detect columns",
  },
  showingFirst: {
    sr: "Prikazano prvih",
    en: "Showing first",
  ...
  return (
    <Box sx={{ position: "relative" }}>
        ...
        >
          ...
          <defs>
            ...
            <linearGradient id="areaGradient" x1="0%" y1="0%" x2="0%" y2="100%">
              ...
              <stop
                offset="100%"
                style={{ stopColor: "#667eea", stopOpacity: 0.1 }}
              />
            </linearGradient>
      ...
      {data.length > 50 && (
        ...
        >
          {getTranslation("showingFirst", locale)} 50{" "}
          {getTranslation("of", locale)} {data.length}{" "}
...
function ColumnChart({ data, stats, width, height, setTooltip, locale }: any) {
      ...
      {slices.map((_slice: any, i: number) => (
        <defs key={`grad-${i}`}>
          ...
          >
            <stop
              offset="0%"
              style={{ stopColor: solidColors[i], stopOpacity: 1 }}
            />
            <stop
              offset="100%"
              style={{ stopColor: solidColors[i], stopOpacity: 0.7 }}
            />
          </linearGradient>
        </defs>
      ))}
