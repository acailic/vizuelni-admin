 ...
 */
const getTargetElement = (elementId) => {
...
export const ExportControls = ({ targetElementId, fileNamePrefix = 'chart', sx }) => {
    ...
    return (<Box sx={{ ...sx }}>
      <Stack direction="row" spacing={2} alignItems="center">
        <Button variant="contained" color="primary" onClick={handleExportPNG} disabled={!!exporting} startIcon={exporting === 'png' ? <CircularProgress size={16} color="inherit"/> : <SvgIcDownload />} sx={{ textTransform: 'none' }}>
          {exporting === 'png' ? 'Eksportovanje...' : 'Preuzmi PNG'}
        </Button>

        <Button variant="outlined" color="primary" onClick={handleExportSVG} disabled={!!exporting} startIcon={exporting === 'svg' ? <CircularProgress size={16} color="inherit"/> : <SvgIcDownload />} sx={{ textTransform: 'none' }}>
