...
const mockDashboardInteractiveFiltersContextValue = (state) => {
    return [
        null,
        null,
        new MockState(state),
...
describe("Dashboard Interactive Filters", () => {
    describe("saveDataFiltersSnapshot", () => {
        it("Save snapshot, modify the store manually, then restore and check result", () => {
            ...
            const restoreComponent1 = saveDataFiltersSnapshot(chartConfigs, stores, "component1");
            setDataFilter(stores.chart1[2], "component1", "modified filter");
            setDataFilter(stores.chart1[2], "component2", "modified filter 2");
            const restoreComponent3 = saveDataFiltersSnapshot(chartConfigs, stores, "component3");
        ...
        it("should handle non-existent component gracefully", () => {
            ...
            const restoreNonExistent = saveDataFiltersSnapshot(chartConfigs, stores, "non-existent-component");
            setDataFilter(stores.chart1[2], "component1", "modified filter");
            restoreNonExistent();
            expect(stores.chart1[2].getState()).toEqual({
                dataFilters: {
