...
export const DataSourceMenu = () => {
    ...
    return (<Flex alignItems="center" gap={1}>
      ...
      <Select id="dataSourceSelect" variant="standard" value={stringifyDataSource(dataSource)} onChange={(e) => {
            setDataSource(parseDataSource(e.target.value));
        }} disabled={isDisabled} options={SOURCE_OPTIONS} sort={false} sx={{
            width: "fit-content",
