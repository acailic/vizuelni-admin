...
const TutorialSearch = ({ tutorials, onFilteredTutorialsChange, locale, }) => {
    ...
    const getCategoryLabel = (category) => {
        ...
        return ((_a = labels[category]) === null || _a === void 0 ? void 0 : _a[locale]) || category;
    };
    const getDifficultyLabel = (difficulty) => {
        ...
        return ((_a = labels[difficulty]) === null || _a === void 0 ? void 0 : _a[locale]) || difficulty;
    };
    return (<Box sx={{ mb: 4 }}>
      <Grid container spacing={2} alignItems="center">
        <Grid item xs={12} sm={6} md={4}>
          <TextField fullWidth label={locale === "sr" ? "Pretraži tutorijale" : "Search tutorials"} variant="outlined" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder={locale === "sr"
        ...
        <Grid item xs={12} sm={6} md={2}>
          <FormControl fullWidth>
            ...
            <Select value={categoryFilter} label={locale === "sr" ? "Kategorija" : "Category"} onChange={(e) => setCategoryFilter(e.target.value)}>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <FormControl fullWidth>
            ...
            <Select value={difficultyFilter} label={locale === "sr" ? "Težina" : "Difficulty"} onChange={(e) => setDifficultyFilter(e.target.value)}>
              <MenuItem value="all">{locale === "sr" ? "Sve" : "All"}</MenuItem>
