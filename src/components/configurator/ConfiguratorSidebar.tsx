...
export function ConfiguratorSidebar({ labels, locale = 'en' }: ConfiguratorSidebarProps) {
  const { step, config, parsedDataset, setStep, setConfig, setParsedDataset } = useConfiguratorStore()
