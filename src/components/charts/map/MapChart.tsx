...
// Get base path for static exports
...
const GEO_JSON_PATHS: Record<GeoLevel, string> = {
  region: `${BASE_PATH}/geo/serbia-regions.geojson`,
  district: `${BASE_PATH}/geo/serbia-districts.geojson`,
  municipality: `${BASE_PATH}/geo/serbia-municipalities.geojson`,
}
