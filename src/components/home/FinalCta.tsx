...
const DEFAULT_TRUST: Record<Locale, { openSource: string; noAccount: string; wcag: string }> = {
  'sr-Cyrl': { openSource: 'Отворен код', noAccount: 'Без регистрације', wcag: 'WCAG 2.1 AA' },
  'sr-Latn': { openSource: 'Otvoren kod', noAccount: 'Bez registracije', wcag: 'WCAG 2.1 AA' },
  en: { openSource: 'Open Source', noAccount: 'No account required', wcag: 'WCAG 2.1 AA' },
};
...
export function FinalCta({
  ...
  const trust = trustLabels ?? DEFAULT_TRUST[locale];
  return (
    <section
