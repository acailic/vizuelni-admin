...
export function HeroSectionAnimated({
  ...
  const previewExample = populationPyramidConfig;
    ...
    >
      ...
      <div className='relative z-10 px-8 py-16 md:py-24'>
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          <div>
            <p
              className='inline-flex items-center gap-2.5 text-sm font-semibold uppercase tracking-[0.25em] text-white/80'
            ...
            <h1
              id='hero-title'
              className='mt-5 font-extrabold leading-[1.05] text-white font-display'
              style={{
            ...
            <p
              className='mt-6 text-lg leading-[1.75] font-light text-white/90 md:text-xl'
              style={{ fontFamily: 'var(--font-family-body)' }}
            >
              {subtitle}
            </p>
          ...
          <div className='relative'>
            <div className='bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 border-t-2 border-t-serbia-red p-6'>
              ...
              {/* Mini chart preview */}
              <div
                className='h-80 overflow-hidden rounded-lg bg-white/5'
                role='img'
