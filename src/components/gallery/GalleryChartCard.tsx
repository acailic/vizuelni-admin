...
import { BarChart3, LineChart, PieChart, TrendingUp, Grid3X3, Eye, Calendar, User } from 'lucide-react'
...
export function GalleryChartCard({ chart, locale, labels }: GalleryChartCardProps) {
  ...
  const chartTypeLabel = labels.chartTypes[chart.chartType as keyof typeof labels.chartTypes] || chart.chartType
