...
import { GalleryFilterBar, type SortOption, type ChartTypeFilter } from './GalleryFilterBar'
...
export function GalleryPage({ locale, labels }: GalleryPageProps) {
  ...
  const fetchCharts = async () => {
    try {
      ...
      const response = await fetch(`/api/gallery?sortBy=${sortBy}&sortOrder=${sortOrder}`)
