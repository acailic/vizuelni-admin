...
import { expandedDemoGalleryExamples } from './demo-gallery-expansion';
...
// Additional curated examples already maintained in the examples library
import { airQualityIndexConfig } from '@/lib/examples/configs/air-quality-index';
import { budgetExecutionConfig } from '@/lib/examples/configs/budget-execution';
import { educationEnrollmentLevelsConfig } from '@/lib/examples/configs/education-enrollment-levels';
import { gdpSectorsConfig } from '@/lib/examples/configs/gdp-sectors';
import { healthIndicatorsConfig } from '@/lib/examples/configs/health-indicators';
import { hospitalCapacityConfig } from '@/lib/examples/configs/hospital-capacity';
import { populationDensityConfig } from '@/lib/examples/configs/population-density';
import { populationPyramidConfig } from '@/lib/examples/configs/population-pyramid';
import { roadAccidentsConfig } from '@/lib/examples/configs/road-accidents';
import { vaccinationRatesConfig } from '@/lib/examples/configs/vaccination-rates';
...
/**
 * Core demo gallery examples organized by category.
 */
const coreDemoGalleryExamples: FeaturedExampleConfig[] = [
  // ============================================
  ...
  },
  {
    ...
    chartConfig: {
      ...
      x_axis: { field: 'ageGroup', type: 'category', label: 'Age Group' },
      y_axis: { field: 'percentage', type: 'linear', label: 'Share (%)' },
      options: {
        showLegend: true,
        showLabels: true,
...
export const demoGalleryExamples: FeaturedExampleConfig[] = [
  ...coreDemoGalleryExamples,
  ...expandedDemoGalleryExamples,
];
