...
export default async function GalleryPageRoute({
  ...
  const labels = {
    ...
    description:
      galleryLabels.description ??
      'Explore visualizations created by the community',
    ...
    tryDifferent:
      galleryLabels.tryDifferent ?? 'Try adjusting your search or filters',
    chartTypes: {
