...
import { BarChart3, LineChart, PieChart, Filter, Map, Share2, Search, ArrowRight, Zap, Lock, Globe } from 'lucide-react'
...
export default function DemoPageClient({ locale, translations }: DemoPageClientProps) {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              {t('hero.description', 'Интерактивна платформа за визуелизацију административних података Србије')}
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              ...
              description={t('features.chartTypesDesc', 'Подршка за преко 8 врста графикона: линијски, стубасти, питасте, мапе и више')}
            />
            <FeatureCard
              icon={<Filter className="h-6 w-6" />}
              title={t('features.interactive', 'Интерактивни филтери')}
              description={t('features.interactiveDesc', 'Филтрирање и анотације у реалном времену')}
            />
            <FeatureCard
              icon={<Map className="h-6 w-6" />}
              title={t('features.maps', 'Географске мапе')}
              description={t('features.mapsDesc', 'Визуелизација података на мапама Србије')}
            />
            <FeatureCard
              icon={<Share2 className="h-6 w-6" />}
              title={t('features.share', 'Дељење и уградња')}
              description={t('features.shareDesc', 'Делите графиконе или их уградите на друге сајтове')}
            />
            <FeatureCard
              icon={<Lock className="h-6 w-6" />}
              title={t('features.secure', 'Сигурност')}
              description={t('features.secureDesc', 'Безбедна аутентификација и управљање подацима')}
            />
            <FeatureCard
              icon={<Globe className="h-6 w-6" />}
              title={t('features.i18n', 'Вишејезичност')}
              description={t('features.i18nDesc', 'Подршка за српски ћирилицу, латиницу и енглески')}
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
            {t('charts.subtitle', 'Истражите разне начине визуелизације ваших података')}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ChartPreviewCard
              icon={<LineChart className="h-8 w-8" />}
              title={t('charts.line', 'Линијски графикони')}
              description={t('charts.lineDesc', 'Идеални за временске серије и трендове')}
              locale={locale}
            />
            <ChartPreviewCard
              icon={<BarChart3 className="h-8 w-8" />}
              title={t('charts.bar', 'Стубасти графикони')}
              description={t('charts.barDesc', 'Перфектни за поређење категорија')}
              locale={locale}
            />
            <ChartPreviewCard
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <StepCard
              ...
              description={t('gettingStarted.step1Desc', 'Прегледајте доступне скупове података или отпремите сопствене')}
            />
            <StepCard
              number="2"
              title={t('gettingStarted.step2', 'Конфигуришите график')}
              description={t('gettingStarted.step2Desc', 'Изаберите тип графикона и подесите параметре')}
            />
            <StepCard
              number="3"
              title={t('gettingStarted.step3', 'Поделите')}
              description={t('gettingStarted.step3Desc', 'Сачувајте и поделите своју визуелизацију')}
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-[#C6363C] to-[#a62d32] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            {t('cta.description', 'Креирајте своју прву визуелизацију за мање од 5 минута')}
          </p>
          <Link
            href={`/${locale}/create`}
      ...
      <footer className="bg-[#0C1E42] text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-slate-400">
            {t('footer.poweredBy', 'Покреће Визуелни Административни Подаци Србије')}
          </p>
...
function ChartPreviewCard({ icon, title, description, locale }: { icon: React.ReactNode; title: string; description: string; locale: string }) {
  return (
    <div className="p-6 rounded-xl bg-white shadow-md hover:shadow-xl transition-shadow">
      ...
      <h3 className="font-semibold text-lg text-[#0C1E42] mb-2 text-center">{title}</h3>
